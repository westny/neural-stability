...
def pixel_accuracy(pred, target, threshold=0.025):
    """
...
def weighted_pixel_accuracy(pred, target, threshold=0.025):
    """
...
def performance_decay(pred, target):
    """
...
def valid_prediction_time(pred, target, threshold=0.025):
    """
